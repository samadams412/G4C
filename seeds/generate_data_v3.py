...
for order in order_data:
    if order['status'] == 'Completed':
        ...
        event_id = random.choice(available_ticket_events_no_cancel)
...
print(f"Sample user: {user_data[0]}") # Will now show first_name and last_name
